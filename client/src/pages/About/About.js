  ...
  return (
    <div className="main-content">
      <div className="homepage-container">
        ...
        <section>
          <p>
            Our Plant Diagnosis & Care App helps you identify plants and
            diagnose any issues that may need attention by simply uploading a
            photo. Whether you're a gardening enthusiast or you just bought your
            first plant, our app makes plant identification, diagnosis, and care
            easy and accessible.
          </p>
        </section>
        <section className="diagnosis-features">
          ...
          <ul>
            ...
            <li>
              Issue Diagnosis: Detect and diagnose issues like watering,
              pruning, and pests.
            </li>
            <li>
        ...
        <section className="about-creators">
          ...
          <div className="creator">
            ...
            <p>Adam is a passionate software developer with a knack for building intuitive user interfaces. Outside of coding, he loves nurturing his Venus flytrap, fascinated by its carnivorous nature and intricate design.</p>
          </div>
          ...
          <div className="creator">
            ...
            <p>Yang is an innovative software developer known for her creative solutions to coding challenges. Away from her computer, she takes pride in tending to her bonsai tree, finding tranquility in its miniature beauty and delicate pruning.</p>
          </div>
        </section>
        <section>
          <div className="creator">
        ...
        <section>
          <div className="creator">
            ...
            <p>Ansel is a forward-thinking software developer with a focus on emerging technologies. Ansel delights in taking care of succulents, admiring their diverse shapes and colors while learning about their unique adaptations.</p>
          </div>
        </section>
      </div>
